...
public class AssignmnetAndMinimum {
    int size;
    long[] operations;
    long[] values;
    private static final long NEUTRAL_ELEMENT = Long.MAX_VALUE - 1;
    private static final long NO_OPERATION = Long.MAX_VALUE;

    AssignmnetAndMinimum(int n){
        size = 1;
        while(size < n) size *= 2;
    ...
    public static void main(String[] args) {
        ...
        int n = sc.nextInt();
        int m = sc.nextInt();
        AssignmnetAndMinimum ms = new AssignmnetAndMinimum(n);
